...
coca=open('cocacola.txt','r')
doritos=open('doritos.txt','r')
etrade=open('etrade.txt','r')
godaddy=open('godaddy.txt','r')

microsoft=open('microsoft.txt','r')
nestle=open('nestle.txt','r')
ikea=open('ikea.txt','r')

evian=open('evian.txt','r')
oldspice=open('oldspice.txt','r')
blend=open('will it blend.txt','r')
