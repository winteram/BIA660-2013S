import tweepy
#authentication
consumer_key='6NKajHEGHLnioi6rYsBkuA'
consumer_secrect='N1ISgapbMtuTZA7EunkjtojojX4tgTy3rLZrhir0mc'
access='729873811-sYG2dxcJj4cWsARUh0RI1S6w6TuGeZenlb8T4qPB'
access_secrect='SZipfFdYOfE4aXKPVpsHS3FJzWDoCj0aJtAo3yDPTs'
...
f=open('D:\python_midterm\status\lumia.txt','w')
lis=mylistener()
streamer=tweepy.Stream(auth=auth,listener=lis,timeout=60)
streamer.filter(track=['nokia lumia'])
