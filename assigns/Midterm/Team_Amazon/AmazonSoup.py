def AmazonSoup():
  ...
  #Model = "Kindle"
  #ModelID = "B0083Q04IQ"         
  #ModelDescr = "Kindle-Fire-Amazon-tablet"
  #ModelName =  "Kindle Fire 7in"
  ## note - approx 7435 reviews    (7 swipes)
  ## left off at iFinish = 740 pages
  ...
  #Model = "Kindle"
  #ModelID = "B0083PWAPW"
  #ModelDescr = "Kindle-Fire-HD"
  #ModelName =  "Kindle Fire 7in HD"
  ## note - approx 9681 reviews      (9 swipes)
  ## left off at iFinish =  960 pages
...
def tryMysqlDBConnectionCursorsNetwork():
    ...
    #strSQL = "INSERT INTO employee (EmplID, LName, FName, Ddate) VALUES (13, db.escape_string('A'BC'), 'XYZ','2013-02-15')"
    #cur.execute(strSQL)
    ...
    strSQL = "Delete From reviews where idreview > 1;"  # " + str(i) + ";"
    print strSQL
    #cur.execute(strSQL)


    #for i in range(121,181,1):
    #  strSQL = "Delete From reviews where idreview > 1;  # " + str(i) + ";"
    #  print strSQL
    #  cur.execute(strSQL)
    ...
    #    print  "this row: %s, %s" % (row["FName"], row["LName"])
